...
This web app use Flask for the communication between the server and the client interface. The server is provided by DigitalOcean. 2 GB of RAM is necessary to run the app for a cost of 10 USD/month. No GPU is used for inference, only CPU.
